...
String gender;
    ...
    private void initComponents() {
        ...
        jLabelRegister.setBackground(new java.awt.Color(102, 255, 102));
        ...
        jRbMale.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jRbFemale.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jCourse.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BSIT", "BSOA", "BSBA", "BSEDUC", " " }));
        ...
        jCheckBox1.setText("Playing Games");
        ...
        jCheckBox5.setText("Singing");

        jCheckBox6.setForeground(new java.awt.Color(255, 255, 255));
        jCheckBox6.setText("Painting");

        jCheckBox7.setForeground(new java.awt.Color(255, 255, 255));
        jCheckBox7.setText("Reading");
    ...
    String gender = jRbMale.isSelected() ? "Male" : "Female"; // Determine the selected gender
    ...
    if (firstName.isEmpty() || lastName.isEmpty() || username.isEmpty() || password.isEmpty() || retypePassword.isEmpty()) {
        ...
        try {
            ...
            writer.newLine();
            writer.write(gender); // Write the selected gender to the file
            writer.newLine();
            writer.close();
    ...
    private void jShowpassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jShowpassActionPerformed
        ...
        jPasswordField1.setEchoChar((char) 0); // Set the echo char to 0 (null)
        jPasswordField2.setEchoChar((char) 0);
    } else {
        // If the checkbox is not selected, hide the password
        jPasswordField1.setEchoChar('*'); // Set the echo char to '*'
